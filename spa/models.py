...
class Habit(models.Model):
    ...
    is_bonus_habit = models.BooleanField(default=False,
                                         verbose_name='Признак '
                                                      'приятной '
                                                      'привычки')
    bonus = models.CharField(null=True, blank=True,
                             max_length=150,
                             verbose_name='Вознаграждение (описание)')
    ...
    place = models.CharField(null=True, blank=True,
                             max_length=150, verbose_name='Место')
    time = models.TimeField(null=True, blank=True, verbose_name='Время')
    period_days = models.PositiveIntegerField(null=True,
                                              blank=True,
